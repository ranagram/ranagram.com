...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppAbout = __webpack_require__(226);
	...
	var WorkStore = function (_ReduceStore) {
	  ...
	  _createClass(WorkStore, [{
	    ...
	    value: function reduce(state, action) {
	      switch (action.type) {
	        case "fetch":
	          return _immutable2.default.Map({ works: action.data });
	          break;
	      }
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppAbout = function (_Component) {
	  ...
	  function AppAbout(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AppAbout).call(this, props));
	  }
